<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <?php }else{ ?>
            <a class="navbar-brand" href="/cms/admin/dashboard.php">CMS Admin</a>
        <?php } ?>
    </div>
    <!-- Top Menu Items -->
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i><?php if(isLoggedIn()){ echo " ".getUsername(); }?>
            <b class="caret"></b></a>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            <li>
                <a href="/cms/admin/dashboard.php"><i class="fa fa-fw fa-dashboard"></i>My Data</a>
            </li>
            <?php if(isAdmin()):?>
                <li>
